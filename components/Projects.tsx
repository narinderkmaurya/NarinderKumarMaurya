...
const Projects = () => {
    return (
        <div>
            <div id='projects' className='sm:px-32 grid grid-cols-4 py-20 gap-4'>
                <div className='col-span-1'>
                    <h1 className='text-3xl dark:text-sky-500 font-semibold pt-4'>Let's Connect</h1>
                ...
                <div className='col-span-3 rounded-md bg-gray-400/20 dark:bg-gray-300/10  p-4'>
                    <h1 className='text-3xl font-semibold dark:text-sky-500 pb-4'>Projects</h1>
                    <div className='grid grid-cols-2  gap-4'>

                        <div className='col-span-1  rounded-md bg-gray-400/20 dark:bg-gray-300/10 px-4 py-4'>
